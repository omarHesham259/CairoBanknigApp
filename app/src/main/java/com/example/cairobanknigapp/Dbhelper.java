...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public void insertTransfer(String fromUser, String toUser, double amount, String date) {
        ...
        // 1. Insert into transfers table (optional but good to keep track)
    ...
    // Get all transactions for a user (returns List<Transaction>)
    public List<TransactionModel> getAllTransactions(String username) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                transactions.add(new TransactionModel(timestamp, amount, type));
    ...
    // Get user ID by username (if needed)
